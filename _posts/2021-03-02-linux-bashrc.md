...
alias la='ls -A'
alias l='ls -CF'
alias cdu='sudo ~/Dropbox/SystemScript.sh'
alias drop='cd ~/Dropbox'
alias c='clear'
alias lego='veracrypt -t -k ~/Dropbox/key-sd --pim=1301 --protect-hidden=no ~/Dropbox/lego /home/baggins/lego'
alias legod='veracrypt -d'
